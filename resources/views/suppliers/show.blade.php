<x-app-layout title="Detail Supplier">
    <div class="flex items-center justify-between mb-6">
        <div>
            <h1 class="text-2xl font-semibold text-gray-900">Detail Supplier</h1>
            <p class="text-gray-600">Informasi lengkap pemasok.</p>
        </div>
        <a href="{{ route('suppliers.edit', $supplier) }}" class="rounded-lg bg-blue-600 px-4 py-2 text-sm font-semibold text-white shadow hover:bg-blue-700">Edit</a>
    </div>
    ...
    <div class="rounded-lg border border-gray-200 bg-white p-6 shadow-sm space-y-4">
        ...
        <div class="grid gap-4 md:grid-cols-2">
            <div>
                <p class="text-xs uppercase text-gray-500">Kontak Person</p>
        ...
        <div class="grid gap-4 md:grid-cols-2">
            ...
            <div>
                ...
                <p class="text-sm text-gray-800 whitespace-pre-line">{{ $supplier->address ?? '-' }}</p>
            </div>
        </div>
        <div class="flex items-center gap-3 pt-2">
            <a href="{{ route('suppliers.index') }}" class="rounded-lg border border-gray-200 px-4 py-2 text-sm font-semibold text-gray-700 hover:bg-gray-50">Kembali</a>
